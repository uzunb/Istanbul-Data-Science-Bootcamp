...
st.write("### Grup 2 - Data Science")
st.write("### Week 4 - Machine Learning Model Deployment")
st.write("#### Project: House Price Prediction")
st.write("##### Authors: Batuhan UZUN, ...")
...
inputDict["Neighborhood"] = st.sidebar.selectbox("Neighborhood", options=variables)
...
inputDict["KitchenQual"] = st.sidebar.selectbox("KitchenQual", options=variables)
variables = droppedDf["GarageFinish"].drop_duplicates().to_list()
inputDict["GarageFinish"] = st.sidebar.selectbox("GarageFinish", options=variables)
